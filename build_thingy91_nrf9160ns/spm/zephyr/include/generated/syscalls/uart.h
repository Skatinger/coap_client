...
extern int z_impl_uart_tx(struct device * dev, const u8_t * buf, size_t len, s32_t timeout);
static inline int uart_tx(struct device * dev, const u8_t * buf, size_t len, s32_t timeout)
{
...
extern int z_impl_uart_rx_enable(struct device * dev, u8_t * buf, size_t len, s32_t timeout);
static inline int uart_rx_enable(struct device * dev, u8_t * buf, size_t len, s32_t timeout)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
