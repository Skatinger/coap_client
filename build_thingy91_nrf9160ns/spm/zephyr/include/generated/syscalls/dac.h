...
extern int z_impl_dac_write_value(struct device * dev, u8_t channel, u32_t value);
static inline int dac_write_value(struct device * dev, u8_t channel, u32_t value)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
