...
extern int z_impl_maxim_ds3231_req_syncpoint(struct device * dev, struct k_poll_signal * signal);
static inline int maxim_ds3231_req_syncpoint(struct device * dev, struct k_poll_signal * signal)
{
...
extern int z_impl_maxim_ds3231_get_syncpoint(struct device * dev, struct maxim_ds3231_syncpoint * syncpoint);
static inline int maxim_ds3231_get_syncpoint(struct device * dev, struct maxim_ds3231_syncpoint * syncpoint)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
